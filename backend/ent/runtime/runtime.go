...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[23].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[35].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[36].Descriptor()
