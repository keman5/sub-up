...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[44].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[57].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[58].Descriptor()
