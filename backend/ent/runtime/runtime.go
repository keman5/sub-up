...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[38].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[50].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[51].Descriptor()
