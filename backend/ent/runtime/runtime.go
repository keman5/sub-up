...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[32].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[44].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[45].Descriptor()
