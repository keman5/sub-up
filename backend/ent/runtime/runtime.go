...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[25].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[37].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[38].Descriptor()
