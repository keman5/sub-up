...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[22].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[34].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[35].Descriptor()
