...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[37].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[49].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[50].Descriptor()
