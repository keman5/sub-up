...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[39].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[52].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[53].Descriptor()
