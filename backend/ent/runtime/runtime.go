...
func init() {
	...
	groupDescQuotaFallbackModel := groupFields[29].Descriptor()
	...
	groupDescModelPolicyMode := groupFields[41].Descriptor()
	...
	groupDescModelPolicyModel := groupFields[42].Descriptor()
