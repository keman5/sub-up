...
type CreateAnnouncementRequest struct {
	...
	EmailPushMode    string                        `json:"email_push_mode" binding:"omitempty,oneof=none all selected"`
	EmailPushUserIDs []int64                       `json:"email_push_user_ids"`
}
...
func (h *AnnouncementHandler) Create(c *gin.Context) {
	...
	input := &service.CreateAnnouncementInput{
		...
		EmailPushMode:    req.EmailPushMode,
		EmailPushUserIDs: req.EmailPushUserIDs,
