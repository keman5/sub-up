...
func TestOpenAIGatewayServiceHandleResponsesImageOutputs_NonStreaming(t *testing.T) {
	...
	result, err := svc.handleNonStreamingResponse(context.Background(), resp, c, &Account{ID: 1, Type: AccountTypeAPIKey}, nil, "gpt-5.4", "gpt-5.4")
...
func TestOpenAIGatewayServiceHandleResponsesImageOutputs_Streaming(t *testing.T) {
	...
	result, err := svc.handleStreamingResponse(context.Background(), resp, c, &Account{ID: 1}, nil, time.Now(), "gpt-5.5", "gpt-5.5")
...
func TestHandleStreamingResponse_CyberPolicyCapturesRealUpstreamTokens(t *testing.T) {
	...
	_, err := svc.handleStreamingResponse(context.Background(), resp, c, &Account{ID: 1}, nil, time.Now(), "gpt-5.5", "gpt-5.5")
