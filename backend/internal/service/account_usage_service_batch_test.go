	...
	repo := &stubOpenAIAccountRepo{
		accounts: []Account{
			...
			},
			{
				...
				Type:     AccountTypeOAuth,
				Extra: map[string]any{
					"codex_main_usage_updated_at": time.Now().UTC().Format(time.RFC3339),
					"codex_main_5h_used_percent":  18.0,
					"codex_main_5h_reset_at":      resetAt.Format(time.RFC3339),
					"codex_main_7d_used_percent":  34.0,
					"codex_main_7d_reset_at":      resetAt.Add(24 * time.Hour).Format(time.RFC3339),
