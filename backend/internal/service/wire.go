...
var ProviderSet = wire.NewSet(
	...
	NewSystemTroubleshootingEvidenceProvider,
	wire.Bind(new(TroubleshootingEvidenceProvider), new(*SystemTroubleshootingEvidenceProvider)),
	ProvideTroubleshootingRateLimiter,
	wire.Bind(new(TroubleshootingRateLimiter), new(*RedisTroubleshootingRateLimiter)),
	ProvideTroubleshootingAssistantService,
