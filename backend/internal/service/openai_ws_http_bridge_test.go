...
func TestOpenAIWSHTTPBridgeOAuthHeadroomOverrideBypassesAccountProxy(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	payload := []byte(`{"type":"response.create","generate":true,"model":"gpt-5.5","stream":true,"input":"hi"}`)
