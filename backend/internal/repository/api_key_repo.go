	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldQuotaFallbackGroupID,
				...
				group.FieldModelPolicyMode,
				group.FieldModelPolicyModel,
				group.FieldRpmLimit,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		DisplayRateMultiplier:           normalizedDisplayRateMultiplier(g.DisplayRateMultiplier),
