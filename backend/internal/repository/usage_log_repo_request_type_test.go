...
func TestPrepareUsageLogInsert_ArgCountMatchesTypes(t *testing.T) {
	...
	require.Equal(t, float64(2), prepared.args[24])
}
...
func TestUsageLogRepositoryGetStatsWithFiltersRequestTypePriority(t *testing.T) {
	...
	mock.ExpectQuery("FROM usage_logs\\s+WHERE \\(request_type = \\$1 OR \\(request_type = 0 AND stream = FALSE AND openai_ws_mode = FALSE\\)\\)").
		...
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"avg_duration_ms",
			"avg_first_token_ms",
		}).AddRow(int64(1), int64(2), int64(3), int64(4), 1.2, 1.0, 1.2, 20.0, 12.0))
...
func TestUsageLogRepositoryGetStatsWithFiltersUsesPresentationMultiplier(t *testing.T) {
	...
	mock.ExpectQuery("SUM\\(COALESCE\\(account_stats_cost, total_cost\\) \\* COALESCE\\(account_rate_multiplier, 1\\) \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)").
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"avg_duration_ms",
			"avg_first_token_ms",
		}).AddRow(int64(1), int64(1200), int64(1000), int64(0), 0.04, 0.08, 0.04, 20.0, 12.0))
	mock.ExpectQuery("SUM\\(FLOOR\\(input_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(GREATEST\\(output_tokens, image_output_tokens\\) \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(cache_creation_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(cache_read_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT\\)").
		WillReturnRows(sqlmock.NewRows([]string{"endpoint", "requests", "total_tokens", "cost", "actual_cost"}))
	mock.ExpectQuery("SUM\\(FLOOR\\(input_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(GREATEST\\(output_tokens, image_output_tokens\\) \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(cache_creation_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT \\+ FLOOR\\(cache_read_tokens \\* COALESCE\\(NULLIF\\(presentation_multiplier, 0\\), 1\\)\\)::BIGINT\\)").
		WillReturnRows(sqlmock.NewRows([]string{"endpoint", "requests", "total_tokens", "cost", "actual_cost"}))
...
func TestUsageLogRepositoryGetStatsWithFiltersAlwaysReturnsAccountCost(t *testing.T) {
	...
	mock.ExpectQuery("FROM usage_logs").
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"total_account_cost", "avg_duration_ms", "avg_first_token_ms",
		}).AddRow(int64(50), int64(1000), int64(2000), int64(100), 15.0, 12.5, 11.0, 100.0, 25.0))
