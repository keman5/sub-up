...
> 状态说明（2026-07-11）：本文所有 Headroom sidecar、后台开关、统计卡片、代理绕过和 worker 调优条目仅保留为历史排障记录，已被 `docs/fork-maintenance/2026-07.md` 的“2026-07-07: 彻底移除 Headroom”决策覆盖。当前代码和线上环境均不得按下文旧复查项恢复 `headroom-*`、`GATEWAY_OPENAI_OAUTH_CODEX_RESPONSES_*`、`openai_headroom_enabled`、Headroom stats API 或运维卡片。
