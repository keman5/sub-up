export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: '用于实时诊断与健康评分；除非环境需要自定义 SLA 阈值，否则建议保持默认。',
        slaMinPercent: '最低 SLA (%)',
        slaMinPercentHint: 'SLA 低于该百分比时，健康状态会降级。',
        ttftP99MaxMs: 'P99 首 Token 最大耗时 (ms)',
        ttftP99MaxMsHint: 'P99 首 Token 耗时超过该值时，健康状态会降级。',
        requestErrorRateMaxPercent: '请求错误率上限 (%)',
        requestErrorRateMaxPercentHint: '客户端/请求错误率超过该百分比时，健康状态会降级。',
        upstreamErrorRateMaxPercent: '上游错误率上限 (%)',
        upstreamErrorRateMaxPercentHint: '上游错误率超过该百分比时，健康状态会降级。',
        silencing: {
          title: '告警静默（维护模式）',
          enabled: '启用静默',
