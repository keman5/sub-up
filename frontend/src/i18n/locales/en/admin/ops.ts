export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Used by realtime diagnosis and health scoring. Leave defaults unless the environment needs custom SLA thresholds.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Health is degraded when SLA falls below this percentage.',
        ttftP99MaxMs: 'P99 TTFT Maximum (ms)',
        ttftP99MaxMsHint: 'Health is degraded when P99 time to first token exceeds this value.',
        requestErrorRateMaxPercent: 'Request Error Rate Maximum (%)',
        requestErrorRateMaxPercentHint: 'Health is degraded when client/request error rate exceeds this percentage.',
        upstreamErrorRateMaxPercent: 'Upstream Error Rate Maximum (%)',
        upstreamErrorRateMaxPercentHint: 'Health is degraded when upstream error rate exceeds this percentage.',
        silencing: {
