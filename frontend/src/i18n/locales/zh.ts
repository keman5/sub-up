  ...
  admin: {
    ...
    subscriptions: {
      ...
      userPicker: {
        ...
        clearSelected: '清空已选',
        emptySelected: '可从最近注册用户或搜索结果中批量选择用户',
        noRecentUsers: '暂无最近注册用户'
      },
      ...
      subscriptionsAssigned: '已为 {count} 个用户分配订阅',
      duplicateConfirmTitle: '确认覆盖已有订阅',
      duplicateConfirmMessage: '用户 {user} 已存在「{group}」订阅。继续后会用本次分配覆盖旧套餐周期，重置开始时间、到期时间和用量统计；系统不会创建第二条同账号同套餐订阅记录，是否继续？',
      duplicateConfirmAction: '确认覆盖',
      assignToUsers: '分配给 {count} 个用户',
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        addModelPattern: '添加模型规则',
        accountAllowlist: '账号放行列表',
        accountAllowlistHint: '搜索并选择需要跳过本规则的 OpenAI 账号，保留 fast mode 不变。',
        accountAllowlistPlaceholder: '账号 ID',
        addAccountID: '添加账号 ID',
        accountSearchPlaceholder: '搜索 OpenAI 账号名称、备注或 ID',
        accountSearchLoading: '正在搜索账号...',
        accountSearchEmpty: '未找到 OpenAI 账号',
        accountFallback: '#{id}',
        removeAccount: '移除账号',
        fallbackAction: '未匹配模型处理方式',
        fallbackActionHint: '当请求模型不在白名单中时的处理方式。',
