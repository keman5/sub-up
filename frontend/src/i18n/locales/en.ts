export default {
  ...
  keys: {
    ...
    resetRateLimitWindowUsage: 'Reset {window}',
    ...
    resetRateLimitWindowConfirmMessage: 'Are you sure you want to reset {window} usage for key "{name}"? This action cannot be undone.',
  ...
  admin: {
    ...
    ops: {
      ...
      alertRules: {
        ...
        metricDescriptions: {
          ...
          disk: 'Current instance root filesystem disk usage (0-100).',
    ...
    settings: {
      ...
      openaiFastPolicy: {
        ...
        addModelPattern: 'Add model pattern',
        accountAllowlist: 'Account allowlist',
        accountAllowlistHint: 'Search and select OpenAI accounts that should bypass this rule and keep fast mode unchanged.',
        accountAllowlistPlaceholder: 'Account ID',
        addAccountID: 'Add account ID',
        accountSearchPlaceholder: 'Search OpenAI account name, note, or ID',
        accountSearchLoading: 'Searching accounts...',
        accountSearchEmpty: 'No OpenAI accounts found',
        accountFallback: '#{id}',
